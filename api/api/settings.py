...
logger.error(f"SETTINGS: EMAIL_HOST: {EMAIL_HOST}")
logger.error(f"SETTINGS: EMAIL_PORT: {EMAIL_PORT}")
logger.error(f"SETTINGS: EMAIL_USE_SSL: {EMAIL_USE_SSL}")
logger.error(f"SETTINGS: EMAIL_HOST_USER: {EMAIL_HOST_USER}")
logger.error(f"SETTINGS: EMAIL_HOST_PASSWORD: {EMAIL_HOST_PASSWORD}")
